...
const Form = () => {
  ...
  return (
        <section>
          <h1 className="text-5xl text-center max-w-[800px] mx-auto mb-4 font-[800]">
          ...
          >
            <div className="relative w-full mt-8 mb-44 md:mb-38">
              ...
              />
              <div className={`border-dashed border-2 py-20 px-8 md:p-16 absolute top-8  w-full h-full flex justify-center flex-col items-center  z-2 rounded-xl text-center ${error.avatar ? 'border-orange-700' : 'border-neutral-3'} `}>
                {ticket.avatar ? (
                  <img
